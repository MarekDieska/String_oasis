<div class="mt-5 bg-dark text_color">
    <div>
        <form id="productForm">
            <div class="row g-4">
                <div class="col-md-8">
                    <div class="mb-2">
                        ...
                        <input type="text" class="form-control" required maxlength="100" placeholder="Názov produktu">
                    </div>
                    <div class="mb-2">
                        <label class="form-label fw-bold">Popis produktu</label>
                        <textarea class="form-control" rows="3" minlength="50" maxlength="500" placeholder="Detailný popis produktu"></textarea>
                    </div>
                    <div class="mb-2 parameters-section">
                        ...
                        <div class="parameter-fields">
                            <div class="row mb-3">
                                <div class="col">
                                    <input type="text" class="form-control" placeholder="Telo">
                                </div>
                                <div class="col">
                                    <input type="text" class="form-control" placeholder="Krk">
                                </div>
                                <div class="col">
                                    <input type="text" class="form-control" placeholder="Počet pražcov">
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="mb-2">
                        ...
                        <div class="input-group mb-3">
                            <input type="number" class="form-control" placeholder="Cena">
                        </div>
                        <div class="input-group mb-3">
                            <input type="number" class="form-control" placeholder="Zľava %">
                        </div>
                    </div>
                    <div class="mb-2">
                ...
                <div class="col-12">
                    <div class="mb-0">
                        ...
                        <div class="drop-zone p-5 text-center border rounded mb-1">
                            <div class="drop-zone-thumb"></div>
                            <p class="mb-0">Drag&Drop alebo vyhadať</p>
                        </div>
                    </div>
                </div>
            </div>
