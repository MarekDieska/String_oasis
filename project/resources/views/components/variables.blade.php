...
$hodnoteniaProduktov = [
    "../components/stars5.blade.php",
    "../components/stars3.blade.php",
    "../components/stars5.blade.php",
    "../components/stars4.blade.php",
    "../components/stars5.blade.php",
];
...
$hodnotenia = [
    [
        ...
        "cas" => "2 týždne dozadu",
        "farba" => "success",
        "hviezdy" => "../components/stars5.blade.php",
        "uspech" => "success"
    ],
    [
    ...
    [
        ...
        "farba" => "danger",
        "hviezdy" => "../components/stars2.blade.php",
        "uspech" => "danger"
    ],
    [
        "nadpis" => "Príliš drahá",
        ...
        "farba" => "success",
        "hviezdy" => "../components/stars4.blade.php",
        "uspech" => "success"
    ],
    [
        "nadpis" => "To je ono!!",
