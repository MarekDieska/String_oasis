<?php
include "../components/variables.blade.php"?>
<?php include "../components/plusModal.blade.php"?>
...
<section class="row justify-content-between align-items-center p-4">
    ...
    <div class="col-12 col-md-6 d-flex flex-column product-detail">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb text_color">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="../song_oasis_laravel/public/index.blade.php">Domov</a></li>
                <li class="breadcrumb-item"><a href="../song_oasis_laravel/public/filters_page.blade.php">Produkty</a></li>
        ...
        <div class="row mb-md-4">
            <div class="col-6 d-flex align-items-center">
                <div class="ratings hidden">
                    <?php include "../components/stars4.blade.php"?>
                </div>
            </div>
