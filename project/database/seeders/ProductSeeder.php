...
class ProductSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Product::create(['subcategory_id' => $subE->id, 'name' => 'Gibson SG Standard Electric Guitar Heritage Cherry', 'brand' => 'Gibson', 'price' => 1799, 'discount' => 0, 'stock' => 1, 'stars' => 5]);
        Product::create(['subcategory_id' => $subE->id, 'name' => 'Fender Squier Affinity Series Stratocaster Lake Placid Blue', 'brand' => 'Fender', 'price' => 233, 'discount' => 0, 'stock' => 1, 'stars' => 3]);
        Product::create(['subcategory_id' => $subE->id, 'name' => 'Vintage 1963 Gibson Barney Kessel Sunburst Finish', 'brand' => 'Gibson', 'price' => 4999, 'discount' => 0, 'stock' => 1, 'stars' => 5]);
        Product::create(['subcategory_id' => $subE->id, 'name' => 'Fender American Professional Jazzmaster Silverburst', 'brand' => 'Fender', 'price' => 1899, 'discount' => 0, 'stock' => 1, 'stars' => 4]);
        Product::create(['subcategory_id' => $subE->id, 'name' => 'Neal Moser Guitar', 'brand' => 'Gibson', 'price' => 650, 'discount' => 0, 'stock' => 1, 'stars' => 5]);
        Product::create(['subcategory_id' => $subE->id, 'name' => 'James Tyler Classic Burning Water', 'brand' => 'Fender', 'price' => 930, 'discount' => 0, 'stock' => 1, 'stars' => 5]);

        $sub4 = Subcategory::where('name', '4 strunové')->first();
        Product::create(['subcategory_id' => $sub4->id, 'name' => 'Ibanez sr300eb', 'brand' => 'Ibanez', 'price' => 350.51, 'discount' => 0, 'stock' => 1, 'stars' => 5]);
        Product::create(['subcategory_id' => $sub4->id, 'name' => 'Ibanez Sr300e-cub', 'brand' => 'Ibanez', 'price' => 820.40, 'discount' => 0, 'stock' => 1, 'stars' => 4]);
        Product::create(['subcategory_id' => $sub4->id, 'name' => 'ibanez gsrm20bwk mikro', 'brand' => 'Ibanez', 'price' => 240.00, 'discount' => 0, 'stock' => 1, 'stars' => 5]);
        Product::create(['subcategory_id' => $sub4->id, 'name' => 'Ibanez SR300EB', 'brand' => 'Ibanez', 'price' => 360.82, 'discount' => 0, 'stock' => 1, 'stars' => 3]);
        Product::create(['subcategory_id' => $sub4->id, 'name' => 'Ibanez SR180 Bass Guitar', 'brand' => 'Ibanez', 'price' => 1800.20, 'discount' => 0, 'stock' => 1, 'stars' => 5]);
        Product::create(['subcategory_id' => $sub4->id, 'name' => 'Yamaha TRBX174EW', 'brand' => 'Yamaha', 'price' => 212.21, 'discount' => 0, 'stock' => 1, 'stars' => 4]);
        Product::create(['subcategory_id' => $sub4->id, 'name' => 'Yamaha TRBX174EW', 'brand' => 'Yamaha', 'price' => 122.22, 'discount' => 0, 'stock' => 1, 'stars' => 3]);
        Product::create(['subcategory_id' => $sub4->id, 'name' => 'Yamaha BB434 Bass ', 'brand' => 'Yamaha', 'price' => 821.31, 'discount' => 0, 'stock' => 1, 'stars' => 5]);
        Product::create(['subcategory_id' => $sub4->id, 'name' => 'Yamaha TRBX174', 'brand' => 'Yamaha', 'price' => 110.21, 'discount' => 0, 'stock' => 1, 'stars' => 5]);
        ...
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Celestial Harmonies - Ethereal Soundscapes', 'brand' => 'Starlight Records', 'price' => 35.99, 'discount' => 0, 'stock' => 1, 'stars' => 4]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Urban Beatdown - Hip Hop Anthology', 'brand' => 'Groove Masters', 'price' => 29.95, 'discount' => 0, 'stock' => 1, 'stars' => 4]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Indie Spectrum - Alternative Explorations', 'brand' => 'Sonic Sounds', 'price' => 24.50, 'discount' => 0, 'stock' => 1, 'stars' => 3]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Acoustic Serenity - Unplugged Collection', 'brand' => 'Harmony House', 'price' => 42.00, 'discount' => 0, 'stock' => 1, 'stars' => 5]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Funky Fusion - Jazz & Groove Revolution', 'brand' => 'Rhythm Nation', 'price' => 38.75, 'discount' => 0, 'stock' => 1, 'stars' => 4]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Digital Frontier - Electronic Odyssey', 'brand' => 'Starlight Records', 'price' => 55.00, 'discount' => 0, 'stock' => 1, 'stars' => 4]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Blues Legacy - Roots & Revival', 'brand' => 'Groove Masters', 'price' => 32.25, 'discount' => 0, 'stock' => 1, 'stars' => 4]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'World Rhythms - Global Soundscapes', 'brand' => 'Sonic Sounds', 'price' => 48.00, 'discount' => 0, 'stock' => 1, 'stars' => 5]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Classic Harmony - Orchestral Masterpieces', 'brand' => 'Harmony House', 'price' => 62.00, 'discount' => 0, 'stock' => 1, 'stars' => 5]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Power Ballads - The Rock Anthems', 'brand' => 'Rhythm Nation', 'price' => 28.00, 'discount' => 0, 'stock' => 1, 'stars' => 4]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Mellow Vibes - Lo-Fi Beats', 'brand' => 'Starlight Records', 'price' => 22.00, 'discount' => 0, 'stock' => 1, 'stars' => 3]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Country Roads - Americana Collection', 'brand' => 'Groove Masters', 'price' => 39.50, 'discount' => 0, 'stock' => 1, 'stars' => 4]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Reggae Sunsplash - Island Grooves', 'brand' => 'Sonic Sounds', 'price' => 33.80, 'discount' => 0, 'stock' => 1, 'stars' => 4]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Gothic Symphony - Dark Wave', 'brand' => 'Harmony House', 'price' => 45.20, 'discount' => 0, 'stock' => 1, 'stars' => 4]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Disco Fever - Dancefloor Classics', 'brand' => 'Rhythm Nation', 'price' => 31.10, 'discount' => 0, 'stock' => 1, 'stars' => 5]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Jazzy Lounge - Cocktail Hour', 'brand' => 'Starlight Records', 'price' => 27.60, 'discount' => 0, 'stock' => 1, 'stars' => 3]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Latin Fire - Salsa & Mambo', 'brand' => 'Groove Masters', 'price' => 41.30, 'discount' => 0, 'stock' => 1, 'stars' => 4]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Ambient Visions - Tranquil Soundscapes', 'brand' => 'Sonic Sounds', 'price' => 52.80, 'discount' => 0, 'stock' => 1, 'stars' => 4]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Bluegrass Journey - Appalachian Sounds', 'brand' => 'Harmony House', 'price' => 36.55, 'discount' => 0, 'stock' => 1, 'stars' => 4]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Celtic Dreams - Mystical Melodies', 'brand' => 'Rhythm Nation', 'price' => 44.90, 'discount' => 0, 'stock' => 1, 'stars' => 5]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Hard Rock Heroes - Guitar Legends', 'brand' => 'Starlight Records', 'price' => 30.40, 'discount' => 0, 'stock' => 1, 'stars' => 4]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Soulful Voices - R&B Divas', 'brand' => 'Groove Masters', 'price' => 29.20, 'discount' => 0, 'stock' => 1, 'stars' => 4]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Experimental Noise - Avant-Garde Sounds', 'brand' => 'Sonic Sounds', 'price' => 47.10, 'discount' => 0, 'stock' => 1, 'stars' => 3]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => '80s Rewind - Synth Pop Hits', 'brand' => 'Harmony House', 'price' => 33.00, 'discount' => 0, 'stock' => 1, 'stars' => 5]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'World Percussion - Tribal Rhythms', 'brand' => 'Rhythm Nation', 'price' => 40.60, 'discount' => 0, 'stock' => 1, 'stars' => 4]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Opera Gala - Vocal Masterpieces', 'brand' => 'Starlight Records', 'price' => 58.30, 'discount' => 0, 'stock' => 1, 'stars' => 5]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Country Classics - Honky Tonk Heroes', 'brand' => 'Groove Masters', 'price' => 31.80, 'discount' => 0, 'stock' => 1, 'stars' => 4]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Indie Folk - Whispering Pines', 'brand' => 'Sonic Sounds', 'price' => 26.90, 'discount' => 0, 'stock' => 1, 'stars' => 3]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Progressive Rock - Sonic Landscapes', 'brand' => 'Harmony House', 'price' => 51.70, 'discount' => 0, 'stock' => 1, 'stars' => 4]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Sacred Chants - Divine Harmonies', 'brand' => 'Rhythm Nation', 'price' => 43.50, 'discount' => 0, 'stock' => 1, 'stars' => 5]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Thrash Metal Fury - Mosh Pit Mayhem', 'brand' => 'Starlight Records', 'price' => 29.70, 'discount' => 0, 'stock' => 1, 'stars' => 4]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Motown Magic - Soulful Sounds', 'brand' => 'Groove Masters', 'price' => 34.20, 'discount' => 0, 'stock' => 1, 'stars' => 5]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Electro Swing - Vintage Remix', 'brand' => 'Sonic Sounds', 'price' => 37.90, 'discount' => 0, 'stock' => 1, 'stars' => 4]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Klezmer Celebration - Jewish Heritage', 'brand' => 'Harmony House', 'price' => 46.40, 'discount' => 0, 'stock' => 1, 'stars' => 4]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Flamenco Passion - Spanish Fire', 'brand' => 'Rhythm Nation', 'price' => 49.10, 'discount' => 0, 'stock' => 1, 'stars' => 5]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => '60s Revolution - Psychedelic Rock', 'brand' => 'Starlight Records', 'price' => 32.50, 'discount' => 0, 'stock' => 1, 'stars' => 4]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Garage Rock Riot - Raw Energy', 'brand' => 'Groove Masters', 'price' => 25.80, 'discount' => 0, 'stock' => 1, 'stars' => 3]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Industrial Strength - Machine Music', 'brand' => 'Sonic Sounds', 'price' => 44.00, 'discount' => 0, 'stock' => 1, 'stars' => 4]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Polka Party - Happy Sounds', 'brand' => 'Harmony House', 'price' => 28.30, 'discount' => 0, 'stock' => 1, 'stars' => 4]);
        Product::create(['subcategory_id' => $subPlatne->id, 'name' => 'Gregorian Voices - Monastic Chants', 'brand' => 'Rhythm Nation', 'price' => 53.60, 'discount' => 0, 'stock' => 1, 'stars' => 5]);
